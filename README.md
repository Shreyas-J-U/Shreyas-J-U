...
const shreyasJU = {
  ...
  education: "B.Tech Computer Science @ PES University, Bengaluru",
  coreSkills: ["MERN Stack", "Next.js", "PostgreSQL", "Supabase"],
  strengths: [
  ...
  interests: ["System Design", "AI/ML", "Performance Optimization"],
  mindset: "Build real products. Ship fast. Improve constantly."
};
```
